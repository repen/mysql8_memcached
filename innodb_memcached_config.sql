...
INSERT INTO containers (name, db_schema, db_table, key_columns, value_columns, flags, cas_column,
expire_time_column, unique_idx_name_on_key) VALUES ('default', 'kv_storage', 'key_val', 'mkey',
'val','flags','cas','expiry', 'PRIMARY');
...
CREATE TABLE key_val ( 
	...
	flags INT, 
	cas BIGINT UNSIGNED, 
	expiry INT, primary key(mkey));

INSERT INTO key_val VALUES ("q", "firs first", 8, 0, 0);
